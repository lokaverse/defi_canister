...
PRODUCTION_CANISTER="ckbtc_test"
...
dfx deploy --upgrade-unchanged ckbtc_test --argument "(opt record {icrc1 = opt record {
  name = opt \"CKBTC\";
  symbol = opt \"CKBTC\";
  ...
  minting_account = opt record{
    owner = principal \"mtyh3-temyy-tmbjp-ftvuq-4fn46-do3rx-kpkmx-sghhf-pfvs7-5viz5-nae\";
    subaccount = null;
  };
  max_supply = null;
...
ICRC_CANISTER=$(dfx canister id ckbtc_test)
